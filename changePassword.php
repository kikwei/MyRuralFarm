<?php
    ...
    if(isset($_SESSION['logInUser']) && isset($_POST['changePassword'])) {
        ...
        $oldPasswordQuery = "SELECT PASSWORD FROM registered_users WHERE CONCAT(EMAIL,' ',PHONENUMBER)='" . $_SESSION['contact'] . "'";
        ...
        while ($oldPass = mysqli_fetch_assoc($result)) {
            ...
            if ($hashOld ==$oldPassArray)
            {
                ...
                {
                    $insertNewPassword = "UPDATE  registered_users SET PASSWORD='$hashNew' WHERE  CONCAT(SURNAME,' ',LASTNAME)='" . $_SESSION['logInUser'] . "'";
