...
$select = "SELECT LandSize,LeasePeriod,LeaseCostPerUnit,LandLocation,LandDescription,OwnerContact FROM lands_on_lease WHERE Status!='Leased'";
    ...
    <form action="BookLandToBuy.php" method="GET">
        <table border='1' align='center' class='table table-hover text-center'>
            ...
            while ($queryResult = mysqli_fetch_array($result)) {
                ...
                echo "<tr><td> $queryResult[0]</td><td> $queryResult[1]</td><td> $queryResult[2]</td><td>$queryResult[3]</td><td> $queryResult[4]</td><td> $queryResult[5]</td></tr>";
            }
            }else{
    ...
    <div class="col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title text-center">Post Latest Lands On Lease</h3>
            </div>
                ...
                <form class="form-horizontal" method="POST" action="">
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-8">
                            <input type="text" class="form-control" placeholder="Post The Latest News on Lands On Lease" name="news" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-md-4 col-md-offset-10 col-lg-4 col-lg-offset-10 col-sm-4 col-sm-offset-10">
                        <button type="submit" class="btn btn-success" name="LeaseNews">Post News</button>
                        </div>
                    </div>
                </form>
            </div>
