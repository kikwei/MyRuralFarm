...
if (count($_POST) > 0) {
    ...
    if (!isset($msg)) {
        ...
        try{
            $Email="SELECT COUNT(*) FROM `registered_users` WHERE `Email`='".$_POST['userEmail']."'";
            ...
            if($count[0]>0){
                ...
                <body>';
                    ...
                    $message .= '<p><a href="'.$url.'/'.'resetPassword.php?id=' . base64_encode($email) .'">Click Here to Reset Your Password</a>';
                    $message .= "</body></html>";
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-12 col-lg-12 col-sm-12" for="surName">Email Address:
                                <input type="email" placeholder="Provide Your Email Address" id="userEmail" class="form-control" name="userEmail">
                            </label>
                        </div>
