...
//Validation to check if Land Cost is provided
    if (!isset($msg)) {
        if (!isset($_POST["landCost"])) {
            $msg = " Land Cost field is required";
            $msgType = 'alert alert-danger';
        }
    }
...
//    }
    ...
    if (!isset($msg)) {
        ...
        $sql = "INSERT INTO lands_on_sale(LandSize,LandCostPerUnit,LandLocation,LandDescription,OwnerContact) 
                      VALUES('" . trim($_POST["landSize"]) . "', '" . trim($_POST["landCost"]) . "', '" . trim($_POST['landLocation']) . "','" . trim($_POST["landDescription"]) . "','" . $_SESSION['contact'] . "')";
...
<div class="col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title text-center"><b>Enter Details of The Farm to Sell</b></h3>
        </div>
        <div class="panel-body">
            <form class="form-horizontal" action="" method="POST" onsubmit="return validateForm()">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-12 col-lg-12 col-sm-12" for="LandCost">Cost Per Unit:
                            <input type="text" placeholder="Enter Land Cost per Unit e.g Ksh.100,000 per Acre" id="landCost" class="form-control" name="landCost">
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-12 col-lg-12 col-sm-12" for="userEmail">Description of The Land:
                            <textarea  placeholder="Describe the Land e.g 50 Metres from Nyahururu-Rumuruti Road, 100 Metres from a stream" id="landDescription" class="form-control" name="landDescription"></textarea>
                        </label>
                    </div>
...
<script type="text/javascript">
    function validateForm() {
        ...
        var landCost = $.trim($("#landCost").val());
        ...
        //validate landCost
        if (landCost == "") {
            alert("Specify the cost of the Land per unit.");
            $("#landCost").focus();
            return false;
        }
